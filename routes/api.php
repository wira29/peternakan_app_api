...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('cages/get-by-location/{location}', [CageController::class, 'getByLocation']);
    ...
    Route::get('goats/get-by-location/{location}', [GoatController::class, 'getByLocation']);
    ...
    Route::get('milk-stocks/get-by-location/{location}', ['App\Http\Controllers\Api\MilkStockController', 'getByLocation']);
